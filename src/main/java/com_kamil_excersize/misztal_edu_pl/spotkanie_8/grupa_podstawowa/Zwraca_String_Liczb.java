...
public class Zwraca_String_Liczb {
    ...
    private static String returnString(int a, int b) {
        String text = "dla BufferReader równego " + a + " b równego " + b + " " + a + "/" + b + "=" + b + "r1";
        return text;
    }
}
/*Zadanie 2. Proszę napisać funkcję, która dla dwóch liczb całkowitych BufferReader i b zwróci string zawierający następujący tekst, np. dla BufferReader = 5 oraz b = 2:
5/2=2 r 1
