package com.kamil.excersize.zadania_7.czas;

public class Main {
    public static void main(String[] args) {
        Czas czas1 = new Czas(13,45);
        Czas czas2 = new Czas(1,10);

        System.out.println("właściwy czas -> " + czas1.CzasWyswietl());

        System.out.println("dodaj czas -> " + czas1.dodaj(czas2));

        System.out.println("odejmij czas -> " + czas1.odejmij(czas2));
    }
}
...
sumowania wszystkich okresów czasu podanych w tablicy będącej pierwszym parametrem
Przykładowy program:
Czas t1(10, 56);
Czas t2(0, 123);
